...
module.exports = async (client, player, track, payload) => {
  ...
  const embed = new MessageEmbed()
    .setAuthor({ name: `Now playing:`, iconURL: 'https://i.ibb.co/vjpT66X/Rainy-Logo-removebg-preview.png' })
  ...
  const row = new MessageActionRow()
    .addComponents(
      new MessageButton()
        .setCustomId("pause")
        .setEmoji("933851070831153202")
        .setStyle("SECONDARY")
    )
    .addComponents(
      new MessageButton()
        .setCustomId("skip")
        .setEmoji("934075927925764147")
        .setStyle("SECONDARY")
    )
    .addComponents(
      new MessageButton()
        .setCustomId("shuffle")
        .setEmoji("933851070361374840")
        .setStyle("SECONDARY")
    )
    .addComponents(
      new MessageButton()
        .setCustomId("loop")
        .setEmoji("933851070084563016")
        .setStyle("SECONDARY")
    )
    .addComponents(
      new MessageButton()
